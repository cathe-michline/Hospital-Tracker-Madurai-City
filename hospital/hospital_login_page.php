			...
			if($result)
			{
				if($result && mysqli_num_rows($result) > 0)
				{
					...
					if($user_data['password'] === $password)
					{
						...
						$_SESSION['hname'] = $user_data['hname'];
...
<title>Login or Signup
    ...
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="https://demos.creative-tim.com/material-kit/index.html">
          Hospital Tracker Madurai City - Hospital Login </a>
  ...
  <div class="page-header header-filter" style="background-image: url('https://i.pinimg.com/originals/dc/6d/35/dc6d35d8d1c661b194612e5718d70a0c.jpg'); background-size: cover; background-position: top center;">
    <div class="container">
      <div class="row">
          ...
          <div class="card card-login">
            ...
            <form class="form" method="POST">
              ...
              <div class="card-header card-header-primary text-center">
                <h4 class="card-title">Login to your hospital</h4> <br>
              </div>
              <br>
              <div class="card-body">
                <div class="input-group">
                  ...
                  <input type="text" name="hname" class="form-control" placeholder="Username" required>
                </div>
                <br>
                <div class="input-group">
                  <div class="input-group-prepend">
              ...
              <br><br>
              <p class="description text-center">Use your Username and Password provided by us
              </p><br>
